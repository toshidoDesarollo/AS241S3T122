...
import {
  ...
  PortalModule,
  TemplatePortal
} from "./chunk-LS3XU4M6.js";
import {
  CdkScrollable
} from "./chunk-LLTNSC43.js";
import {
  _animationsDisabled
} from "./chunk-3MGPN52P.js";
...
import {
  Directionality
} from "./chunk-DRGRLKGG.js";
import "./chunk-MWEPKM45.js";
import {
  Platform,
  coerceNumberProperty
} from "./chunk-SPJVBSJ4.js";
...
__name(CdkDialogContainer_ng_template_0_Template, "CdkDialogContainer_ng_template_0_Template");
var _DialogConfig = class _DialogConfig {
  /**
...
__name(_DialogConfig, "DialogConfig");
var DialogConfig = _DialogConfig;
function throwDialogContentAlreadyAttachedError() {
  throw Error("Attempting to attach dialog content after content is already attached");
}
__name(throwDialogContentAlreadyAttachedError, "throwDialogContentAlreadyAttachedError");
...
__name(_CdkDialogContainer, "CdkDialogContainer");
__publicField(_CdkDialogContainer, "ɵfac", /* @__PURE__ */ __name(function CdkDialogContainer_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkDialogContainer)();
}, "CdkDialogContainer_Factory"));
__publicField(_CdkDialogContainer, "ɵcmp", ɵɵdefineComponent({
  type: _CdkDialogContainer,
  selectors: [["cdk-dialog-container"]],
  viewQuery: /* @__PURE__ */ __name(function CdkDialogContainer_Query(rf, ctx) {
    if (rf & 1) {
  ...
  hostVars: 6,
  hostBindings: /* @__PURE__ */ __name(function CdkDialogContainer_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("id", ctx._config.id || null)("role", ctx._config.role)("aria-modal", ctx._config.ariaModal)("aria-labelledby", ctx._config.ariaLabel ? null : ctx._ariaLabelledByQueue[0])("aria-label", ctx._config.ariaLabel)("aria-describedby", ctx._config.ariaDescribedBy || null);
    }
  }, "CdkDialogContainer_HostBindings"),
  features: [ɵɵInheritDefinitionFeature],
  decls: 1,
  vars: 0,
  consts: [["cdkPortalOutlet", ""]],
  template: /* @__PURE__ */ __name(function CdkDialogContainer_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵtemplate(0, CdkDialogContainer_ng_template_0_Template, 0, 0, "ng-template", 0);
    }
  }, "CdkDialogContainer_Template"),
...
var _DialogRef = class _DialogRef {
  overlayRef;
  config;
  /**
...
__name(_DialogRef, "DialogRef");
var DialogRef = _DialogRef;
...
__name(getDirectionality, "getDirectionality");
...
__publicField(_Dialog, "ɵfac", /* @__PURE__ */ __name(function Dialog_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _Dialog)();
}, "Dialog_Factory"));
__publicField(_Dialog, "ɵprov", ɵɵdefineInjectable({
  token: _Dialog,
...
__name(reverseForEach, "reverseForEach");
var _DialogModule = class _DialogModule {
};
__name(_DialogModule, "DialogModule");
__publicField(_DialogModule, "ɵfac", /* @__PURE__ */ __name(function DialogModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DialogModule)();
}, "DialogModule_Factory"));
...
__name(MatDialogContainer_ng_template_2_Template, "MatDialogContainer_ng_template_2_Template");
var _MatDialogConfig = class _MatDialogConfig {
  /**
   * Where the attached component should live in Angular's *logical* component tree.
   * This affects what is available for injection and the change detection order for the
   * component instantiated inside of the dialog. This does not affect where the dialog
...
__name(_MatDialogConfig, "MatDialogConfig");
var MatDialogConfig = _MatDialogConfig;
...
var _MatDialogContainer = class _MatDialogContainer extends CdkDialogContainer {
   ...
   */
  _finishDialogOpen = /* @__PURE__ */ __name(() => {
   ...
   */
  _finishDialogClose = /* @__PURE__ */ __name(() => {
    this._clearAnimationClasses();
    this._animationStateChanged.emit({
      state: "closed",
      totalTime: this._exitAnimationDuration
...
__name(_MatDialogContainer, "MatDialogContainer");
__publicField(_MatDialogContainer, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatDialogContainer_BaseFactory;
  return /* @__PURE__ */ __name(function MatDialogContainer_Factory(__ngFactoryType__) {
  ...
  }, "MatDialogContainer_Factory");
})());
__publicField(_MatDialogContainer, "ɵcmp", ɵɵdefineComponent({
  type: _MatDialogContainer,
  selectors: [["mat-dialog-container"]],
  hostAttrs: ["tabindex", "-1", 1, "mat-mdc-dialog-container", "mdc-dialog"],
  hostVars: 10,
  hostBindings: /* @__PURE__ */ __name(function MatDialogContainer_HostBindings(rf, ctx) {
    if (rf & 2) {
  ...
  }, "MatDialogContainer_HostBindings"),
  features: [ɵɵInheritDefinitionFeature],
  decls: 3,
  vars: 0,
  consts: [[1, "mat-mdc-dialog-inner-container", "mdc-dialog__container"], [1, "mat-mdc-dialog-surface", "mdc-dialog__surface"], ["cdkPortalOutlet", ""]],
  template: /* @__PURE__ */ __name(function MatDialogContainer_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementStart(0, "div", 0)(1, "div", 1);
      ɵɵtemplate(2, MatDialogContainer_ng_template_2_Template, 0, 0, "ng-template", 2);
      ɵɵelementEnd()();
    }
  }, "MatDialogContainer_Template"),
  dependencies: [CdkPortalOutlet],
...
__name(parseCssTime, "parseCssTime");
var MatDialogState;
...
var _MatDialogRef = class _MatDialogRef {
  _ref;
  _config;
  _containerInstance;
...
__name(_MatDialogRef, "MatDialogRef");
var MatDialogRef = _MatDialogRef;
function _closeDialogVia(ref, interactionType, result) {
  ref._closeInteractionType = interactionType;
  return ref.close(result);
}
__name(_closeDialogVia, "_closeDialogVia");
...
var _MatDialog = class _MatDialog {
  ...
  open(componentOrTemplateRef, config) {
    ...
    const cdkRef = this._dialog.open(componentOrTemplateRef, __spreadProps(__spreadValues({}, config), {
      ...
      templateContext: /* @__PURE__ */ __name(() => ({
        dialogRef
      }), "templateContext"),
      providers: /* @__PURE__ */ __name((ref, cdkConfig, dialogContainer) => {
...
__name(_MatDialog, "MatDialog");
__publicField(_MatDialog, "ɵfac", /* @__PURE__ */ __name(function MatDialog_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDialog)();
}, "MatDialog_Factory"));
__publicField(_MatDialog, "ɵprov", ɵɵdefineInjectable({
  token: _MatDialog,
...
__name(_MatDialogClose, "MatDialogClose");
__publicField(_MatDialogClose, "ɵfac", /* @__PURE__ */ __name(function MatDialogClose_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDialogClose)();
}, "MatDialogClose_Factory"));
__publicField(_MatDialogClose, "ɵdir", ɵɵdefineDirective({
  type: _MatDialogClose,
  selectors: [["", "mat-dialog-close", ""], ["", "matDialogClose", ""]],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function MatDialogClose_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("click", /* @__PURE__ */ __name(function MatDialogClose_click_HostBindingHandler($event) {
        return ctx._onButtonClick($event);
      }, "MatDialogClose_click_HostBindingHandler"));
    }
    if (rf & 2) {
      ɵɵattribute("aria-label", ctx.ariaLabel || null)("type", ctx.type);
    }
  }, "MatDialogClose_HostBindings"),
  inputs: {
...
__name(_MatDialogLayoutSection, "MatDialogLayoutSection");
__publicField(_MatDialogLayoutSection, "ɵfac", /* @__PURE__ */ __name(function MatDialogLayoutSection_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDialogLayoutSection)();
}, "MatDialogLayoutSection_Factory"));
__publicField(_MatDialogLayoutSection, "ɵdir", ɵɵdefineDirective({
...
__name(_MatDialogTitle, "MatDialogTitle");
__publicField(_MatDialogTitle, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatDialogTitle_BaseFactory;
  return /* @__PURE__ */ __name(function MatDialogTitle_Factory(__ngFactoryType__) {
  ...
  }, "MatDialogTitle_Factory");
})());
__publicField(_MatDialogTitle, "ɵdir", ɵɵdefineDirective({
  type: _MatDialogTitle,
  selectors: [["", "mat-dialog-title", ""], ["", "matDialogTitle", ""]],
  hostAttrs: [1, "mat-mdc-dialog-title", "mdc-dialog__title"],
  hostVars: 1,
  hostBindings: /* @__PURE__ */ __name(function MatDialogTitle_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵdomProperty("id", ctx.id);
    }
  }, "MatDialogTitle_HostBindings"),
  inputs: {
    id: "id"
  },
...
__name(_MatDialogContent, "MatDialogContent");
__publicField(_MatDialogContent, "ɵfac", /* @__PURE__ */ __name(function MatDialogContent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDialogContent)();
}, "MatDialogContent_Factory"));
__publicField(_MatDialogContent, "ɵdir", ɵɵdefineDirective({
...
__name(_MatDialogActions, "MatDialogActions");
__publicField(_MatDialogActions, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatDialogActions_BaseFactory;
  return /* @__PURE__ */ __name(function MatDialogActions_Factory(__ngFactoryType__) {
  ...
  }, "MatDialogActions_Factory");
})());
__publicField(_MatDialogActions, "ɵdir", ɵɵdefineDirective({
  type: _MatDialogActions,
  selectors: [["", "mat-dialog-actions", ""], ["mat-dialog-actions"], ["", "matDialogActions", ""]],
  hostAttrs: [1, "mat-mdc-dialog-actions", "mdc-dialog__actions"],
  hostVars: 6,
  hostBindings: /* @__PURE__ */ __name(function MatDialogActions_HostBindings(rf, ctx) {
    if (rf & 2) {
...
__name(getClosestDialog, "getClosestDialog");
...
__name(_MatDialogModule, "MatDialogModule");
__publicField(_MatDialogModule, "ɵfac", /* @__PURE__ */ __name(function MatDialogModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatDialogModule)();
}, "MatDialogModule_Factory"));
__publicField(_MatDialogModule, "ɵmod", ɵɵdefineNgModule({
...
__publicField(_MatDialogModule, "ɵinj", ɵɵdefineInjector({
  providers: [MatDialog],
