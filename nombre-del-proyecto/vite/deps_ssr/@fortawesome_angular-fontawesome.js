...
import {
  DomSanitizer
} from "./chunk-VASABKNN.js";
import "./chunk-ZLAZJ2PG.js";
import "./chunk-YFVSNA4W.js";
...
function _createForOfIteratorHelper(r2, e2) {
  ...
  if (!t2) {
    if (Array.isArray(r2) || (t2 = _unsupportedIterableToArray(r2)) || e2 && r2 && "number" == typeof r2.length) {
      t2 && (r2 = t2);
      var n2 = 0, F2 = /* @__PURE__ */ __name(function() {
      }, "F");
      return {
        s: F2,
...
function _wrapRegExp() {
  _wrapRegExp = /* @__PURE__ */ __name(function(e3, r3) {
...
var functions = [];
var _listener = /* @__PURE__ */ __name(function listener() {
...
__name(isSecondaryLayer, "isSecondaryLayer");
...
var hasPseudoElement = /* @__PURE__ */ __name(function hasPseudoElement2(selector) {
  return !!selector && PSEUDO_ELEMENTS.some(function(pseudoSelector) {
    return selector.includes(pseudoSelector);
  });
}, "hasPseudoElement");
var parseCSSRuleForPseudos = /* @__PURE__ */ __name(function parseCSSRuleForPseudos2(selectorText) {
...
var PseudoElements = {
  ...
  provides: /* @__PURE__ */ __name(function provides3(providers2) {
...
__name(_FaConfig, "FaConfig");
__publicField(_FaConfig, "ɵfac", /* @__PURE__ */ __name(function FaConfig_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaConfig)();
}, "FaConfig_Factory"));
__publicField(_FaConfig, "ɵprov", ɵɵdefineInjectable({
  token: _FaConfig,
...
__name(_FaIconLibrary, "FaIconLibrary");
__publicField(_FaIconLibrary, "ɵfac", /* @__PURE__ */ __name(function FaIconLibrary_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaIconLibrary)();
}, "FaIconLibrary_Factory"));
__publicField(_FaIconLibrary, "ɵprov", ɵɵdefineInjectable({
...
var faWarnIfIconDefinitionMissing = /* @__PURE__ */ __name((iconSpec) => {
  throw new Error(`Could not find icon with iconName=${iconSpec.iconName} and prefix=${iconSpec.prefix} in the icon library.`);
}, "faWarnIfIconDefinitionMissing");
var faWarnIfIconSpecMissing = /* @__PURE__ */ __name(() => {
  throw new Error("Property `icon` is required for `fa-icon`/`fa-duotone-icon` components.");
}, "faWarnIfIconSpecMissing");
var isKnownRotateValue = /* @__PURE__ */ __name((rotate) => rotate != null && (rotate === 90 || rotate === 180 || rotate === 270 || rotate === "90" || rotate === "180" || rotate === "270"), "isKnownRotateValue");
var faClassList = /* @__PURE__ */ __name((props) => {
...
__name(ensureCss2, "ensureCss");
var isIconLookup = /* @__PURE__ */ __name((i2) => i2.prefix !== void 0 && i2.iconName !== void 0, "isIconLookup");
var faNormalizeIconSpec = /* @__PURE__ */ __name((iconSpec, defaultPrefix) => {
...
__name(_FaStackItemSizeDirective, "FaStackItemSizeDirective");
__publicField(_FaStackItemSizeDirective, "ɵfac", /* @__PURE__ */ __name(function FaStackItemSizeDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaStackItemSizeDirective)();
}, "FaStackItemSizeDirective_Factory"));
__publicField(_FaStackItemSizeDirective, "ɵdir", ɵɵdefineDirective({
...
__name(_FaStackComponent, "FaStackComponent");
__publicField(_FaStackComponent, "ɵfac", /* @__PURE__ */ __name(function FaStackComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaStackComponent)();
}, "FaStackComponent_Factory"));
__publicField(_FaStackComponent, "ɵcmp", ɵɵdefineComponent({
  type: _FaStackComponent,
  selectors: [["fa-stack"]],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function FaStackComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassMap(ctx.classes());
    }
  }, "FaStackComponent_HostBindings"),
  inputs: {
    size: [1, "size"]
  },
  ...
  decls: 1,
  vars: 0,
  template: /* @__PURE__ */ __name(function FaStackComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵprojection(0);
    }
  }, "FaStackComponent_Template"),
  encapsulation: 2,
  changeDetection: 0
}));
...
__name(_FaIconComponent, "FaIconComponent");
__publicField(_FaIconComponent, "ɵfac", /* @__PURE__ */ __name(function FaIconComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaIconComponent)();
}, "FaIconComponent_Factory"));
__publicField(_FaIconComponent, "ɵcmp", ɵɵdefineComponent({
  type: _FaIconComponent,
  selectors: [["fa-icon"]],
  hostAttrs: [1, "ng-fa-icon"],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function FaIconComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵdomProperty("innerHTML", ctx.renderedIconHTML(), ɵɵsanitizeHtml);
      ɵɵattribute("title", ctx.title() ?? void 0);
    }
  }, "FaIconComponent_HostBindings"),
  inputs: {
    icon: [1, "icon"],
    title: [1, "title"],
  ...
  decls: 0,
  vars: 0,
  template: /* @__PURE__ */ __name(function FaIconComponent_Template(rf, ctx) {
  }, "FaIconComponent_Template"),
  encapsulation: 2,
  changeDetection: 0
}));
...
__name(_FaDuotoneIconComponent, "FaDuotoneIconComponent");
__publicField(_FaDuotoneIconComponent, "ɵfac", /* @__PURE__ */ (() => {
  let ɵFaDuotoneIconComponent_BaseFactory;
  return /* @__PURE__ */ __name(function FaDuotoneIconComponent_Factory(__ngFactoryType__) {
  ...
  }, "FaDuotoneIconComponent_Factory");
})());
__publicField(_FaDuotoneIconComponent, "ɵcmp", ɵɵdefineComponent({
  ...
  decls: 0,
  vars: 0,
  template: /* @__PURE__ */ __name(function FaDuotoneIconComponent_Template(rf, ctx) {
  }, "FaDuotoneIconComponent_Template"),
  encapsulation: 2,
  changeDetection: 0
}));
...
var faWarnIfParentNotExist = /* @__PURE__ */ __name((parent, parentName, childName) => {
  if (!parent) {
...
__name(_FaLayersComponent, "FaLayersComponent");
__publicField(_FaLayersComponent, "ɵfac", /* @__PURE__ */ __name(function FaLayersComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaLayersComponent)();
}, "FaLayersComponent_Factory"));
__publicField(_FaLayersComponent, "ɵcmp", ɵɵdefineComponent({
  type: _FaLayersComponent,
  selectors: [["fa-layers"]],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function FaLayersComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassMap(ctx.classes());
    }
  }, "FaLayersComponent_HostBindings"),
  inputs: {
    size: [1, "size"],
    fixedWidth: [1, "fixedWidth"]
  },
  ...
  decls: 1,
  vars: 0,
  template: /* @__PURE__ */ __name(function FaLayersComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵprojection(0);
    }
  }, "FaLayersComponent_Template"),
  encapsulation: 2,
  changeDetection: 0
}));
...
__name(_FaLayersCounterComponent, "FaLayersCounterComponent");
__publicField(_FaLayersCounterComponent, "ɵfac", /* @__PURE__ */ __name(function FaLayersCounterComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaLayersCounterComponent)();
}, "FaLayersCounterComponent_Factory"));
__publicField(_FaLayersCounterComponent, "ɵcmp", ɵɵdefineComponent({
  type: _FaLayersCounterComponent,
  selectors: [["fa-layers-counter"]],
  hostAttrs: [1, "ng-fa-layers-counter"],
  hostVars: 1,
  hostBindings: /* @__PURE__ */ __name(function FaLayersCounterComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵdomProperty("innerHTML", ctx.renderedHTML(), ɵɵsanitizeHtml);
    }
  }, "FaLayersCounterComponent_HostBindings"),
  inputs: {
    content: [1, "content"],
    title: [1, "title"],
    position: [1, "position"]
  ...
  decls: 0,
  vars: 0,
  template: /* @__PURE__ */ __name(function FaLayersCounterComponent_Template(rf, ctx) {
  }, "FaLayersCounterComponent_Template"),
  encapsulation: 2,
  changeDetection: 0
}));
...
__name(_FaLayersTextComponent, "FaLayersTextComponent");
__publicField(_FaLayersTextComponent, "ɵfac", /* @__PURE__ */ __name(function FaLayersTextComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FaLayersTextComponent)();
}, "FaLayersTextComponent_Factory"));
__publicField(_FaLayersTextComponent, "ɵcmp", ɵɵdefineComponent({
  type: _FaLayersTextComponent,
  selectors: [["fa-layers-text"]],
  hostAttrs: [1, "ng-fa-layers-text"],
  hostVars: 1,
  hostBindings: /* @__PURE__ */ __name(function FaLayersTextComponent_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵdomProperty("innerHTML", ctx.renderedHTML(), ɵɵsanitizeHtml);
    }
  }, "FaLayersTextComponent_HostBindings"),
  inputs: {
    content: [1, "content"],
    title: [1, "title"],
    flip: [1, "flip"],
  ...
  decls: 0,
  vars: 0,
  template: /* @__PURE__ */ __name(function FaLayersTextComponent_Template(rf, ctx) {
  }, "FaLayersTextComponent_Template"),
  encapsulation: 2,
  changeDetection: 0
}));
...
__name(_FontAwesomeModule, "FontAwesomeModule");
__publicField(_FontAwesomeModule, "ɵfac", /* @__PURE__ */ __name(function FontAwesomeModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FontAwesomeModule)();
}, "FontAwesomeModule_Factory"));
__publicField(_FontAwesomeModule, "ɵmod", ɵɵdefineNgModule({
...
__publicField(_FontAwesomeModule, "ɵinj", ɵɵdefineInjector({}));
